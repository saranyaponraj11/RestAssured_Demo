...
public class Create_an_address_Update_an_address_usingutilityfunction {
	String ID;
	...
	public void Create_Address() throws IOException, ParseException {
		...
		Response response = RestAssured.given()
				...
				.body(Util_Function.readFile("updated_address.json"))
	...
	public void Update_Address() throws IOException, ParseException {
		...
		Assert.assertEquals(firstName, "saranya");

		String lastName = default_billing_address.get("lastname");
		Assert.assertEquals(lastName, "ponraj");
